...
describe("Asserting not null or undefined", () => {
  it("test asserIsNotNullOrUndefined", async () => {
    ...
    MethodFailedException.assertNotNullOrUndefined("hurray!");
    expect(() => MethodFailedException.assertNotNullOrUndefined(null)).toThrow(new MethodFailedException(exMsg));
